            ...
            while ((operazione = stdIn.readLine()) != null) {
                ...
                if (operazione.equals("op1")) {
                    System.out.println("Inserire input");
                     carattere = (char)stdIn.read();
                     stdIn.readLine();
                    try{
                        occorrenza = Integer.parseInt(stdIn.readLine());
                    }catch(NumberFormatException nfe){
                        continue;
                    }
                    outSock.writeChar(carattere);
                    outSock.writeInt(occorrenza);
                     res = inSock.readInt();
                    ...
                    if (dirEsiste != 0) {
                        ...
                        System.out.println("MGET - Direttorio: " + input);
