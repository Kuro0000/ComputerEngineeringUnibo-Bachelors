...
{
	union {
		nome_t getlista_1_arg;
		PuntoClient getlista_sa_1_arg;
	} argument;
	char *result;
	...
	case GETLISTA:
		_xdr_argument = (xdrproc_t) xdr_nome_t;
		_xdr_result = (xdrproc_t) xdr_Risposta;
		local = (char *(*)(char *, struct svc_req *)) getlista_1_svc;
		break;

	case GETLISTA_SA:
		_xdr_argument = (xdrproc_t) xdr_PuntoClient;
		_xdr_result = (xdrproc_t) xdr_Risposta;
		local = (char *(*)(char *, struct svc_req *)) getlista_sa_1_svc;
		break;
